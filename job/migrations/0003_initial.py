...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('job', '0002_remove_jobs_author_remove_jobs_education_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='JobRequiredSkills', to='job.jobs')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('skills', models.CharField(max_length=200)),
                ('job', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='JobEducation_Experience', to='job.jobs')),
            ],
        ),
    ]
